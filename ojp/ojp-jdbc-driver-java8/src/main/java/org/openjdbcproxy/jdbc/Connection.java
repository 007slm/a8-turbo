...
public class Connection implements java.sql.Connection {
    ...
    public java.sql.Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        ...
        return new Statement(this, statementService, this.hashMapOf(
                ...
                ), Arrays.asList(resultSetType, resultSetConcurrency)
        ));
    }
    ...
    public java.sql.Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        ...
        return new Statement(this, statementService, this.hashMapOf(
                Arrays.asList(CommonConstants.STATEMENT_RESULT_SET_TYPE_KEY,
                        CommonConstants.STATEMENT_RESULT_SET_CONCURRENCY_KEY,
                        CommonConstants.STATEMENT_RESULT_SET_HOLDABILITY_KEY)
                , Arrays.asList(resultSetType, resultSetConcurrency, resultSetHoldability)));
    }
    ...
    public java.sql.PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        ...
        return new PreparedStatement(this, sql, this.statementService, this.hashMapOf(
                Arrays.asList(CommonConstants.STATEMENT_AUTO_GENERATED_KEYS_KEY)
                , Arrays.asList(autoGeneratedKeys)));
    }
    ...
    public java.sql.PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        ...
        return new PreparedStatement(this, sql, this.statementService, this.hashMapOf(
                Arrays.asList(CommonConstants.STATEMENT_COLUMN_INDEXES_KEY)
                , Arrays.asList(columnIndexes)));
    }
    ...
    public java.sql.PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        ...
        return new PreparedStatement(this, sql, this.statementService, this.hashMapOf(
                Arrays.asList(CommonConstants.STATEMENT_COLUMN_NAMES_KEY)
                , values));
    }
