...
## 容器 IP 分配一览表 (Subnet: 172.24.0.0/16)

| 分类 | 服务名称 | IP 地址 |
|---|---|---|
| **基础服务** | dns-server | 172.24.0.2 |
| | prometheus | 172.24.0.3 |
| | grafana | 172.24.0.4 |
| | redis | 172.24.0.5 |
| | redis-exporter | 172.24.0.6 |
| | phpredmin | 172.24.0.7 |
| **数据库** | mysql | 172.24.0.10 |
| | mysql5 | 172.24.0.11 |
| | mysql-exporter | 172.24.0.12 |
| | starrocks | 172.24.0.13 |
| **CDC & 同步** | seatunnel-master | 172.24.0.20 |
| | seatunnel-worker1 | 172.24.0.21 |
| **网关** | kong | 172.24.0.30 |
| **开发代理** | ojp-server | 172.24.0.40 |
| | ojp-ui | 172.24.0.41 |
| | shopservice | 172.24.0.42 |
| **其他组件** | oracle | 172.24.0.50 |
| | windows7 | 172.24.0.51 |
