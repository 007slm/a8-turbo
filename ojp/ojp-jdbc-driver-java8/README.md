# OJP JDBC Driver (Java 8 Compatible)

OJP JDBC 驱动程序的 Java 8 兼容版本，用于连接到 OJP 代理服务器，提供透明的数据库访问和缓存功能。
...
- **JDBC 4.2 兼容**: 完全符合 JDBC 4.2 规范（Java 8 标准）
...
| JDBC 规范 | JDBC 4.2 | JDBC 4.3+ |
| 依赖 | 兼容 Java 8 生态 | 使用最新 Java 特性 |
| 性能 | 略低（兼容性考虑） | 更优 |

**选择建议**:
- 使用 Java 8 或需要兼容 Java 8 环境 → 选择本版本
- 使用 Java 11+ → 选择标准版本（`ojp-jdbc-driver`）
...
<dependency>
    ...
    <artifactId>ojp-jdbc-driver-java8</artifactId>
...
```groovy
implementation 'org.openjdbcproxy:ojp-jdbc-driver-java8:0.0.8-alpha'
```
...
# 复制驱动 JAR
COPY ojp-jdbc-driver-java8-0.0.8-alpha.jar /app/

# 设置 CLASSPATH
ENV CLASSPATH=/app/ojp-jdbc-driver-java8-0.0.8-alpha.jar:/app/app.jar
...
- [开发指南](../AGENTS.md)
- [标准版本驱动](../ojp-jdbc-driver/README.md)
...
**OJP JDBC Driver (Java 8)** - 让 Java 8 应用也能享受智能缓存！