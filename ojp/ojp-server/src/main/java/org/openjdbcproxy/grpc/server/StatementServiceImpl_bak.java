...
public class StatementServiceImpl_bak extends StatementServiceGrpc.StatementServiceImplBase {
    ...
    public void executeUpdate(StatementRequest request, StreamObserver<OpResult> responseObserver) {
        ...
        try {
            ...
            List<Parameter> params = deserializeParameters(request.getParameters().toByteArray());
            PreparedStatement ps = CollectionUtils.isNotEmpty(params) ?
                    StatementFactory.createPreparedStatement(
                            ...
                            (List<Parameter>) (List<?>) params, request) :
